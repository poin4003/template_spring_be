...
public class MyBatisPlusConfig {
    ...
    public ConfigurationCustomizer configurationCustomizer() {
        return configuration -> {
            ...
            configuration.getTypeHandlerRegistry().register(ActionStatusEnum.class, new GenericEnumTypeHandler<>(ActionStatusEnum.class));
            configuration.getTypeHandlerRegistry().register(ActionTypeEnum.class, new GenericEnumTypeHandler<>(ActionTypeEnum.class));
            configuration.getTypeHandlerRegistry().register(TargetTypeEnum.class, new GenericEnumTypeHandler<>(TargetTypeEnum.class));
        };
    }
}
